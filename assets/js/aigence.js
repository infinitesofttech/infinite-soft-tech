(function ($) {
  ...
  function dynamicCurrentMenuClass(selector) {
    ...
    selector.find("li").each(function () {
      ...
      if ($(anchor).attr("href") === FileName && !found) {
...
if (contactForm) {
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('https://infinity3tech.pythonanywhere.com/contact-us/', {
                method: 'POST',
                headers: {
            ...
            responseDiv.innerHTML = `<p style="color: red;">Failed to connect to server.</p>`;
        }
    });
}